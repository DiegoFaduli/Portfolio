  ...
  return (
    <div className="w-full">
      <div className="mx-auto flex flex-col justify-center">
        <p className="font-bold text-blue-900 pb-4 text-center">My Skills</p>
        ...
        <ul className="flex justify-start items-center flex-row gap-8 flex-wrap mb-2 p-8">
        ...
        <ul className="flex items-center flex-row gap-8 flex-wrap mb-2 p-8">
